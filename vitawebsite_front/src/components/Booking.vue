  ...
  <div class="container pb-5 mb-2">
    <div class="container-fluid">
      <div class="titlestyles d-flex py-4 my-4">
        <h1 class="titile-style">
          <img src="../img/titleicon.png" />商品預訂清單
        </h1>
      </div>
        ...
        <div class="px-3 my-3">
          <a class="cart-item-product" href="#">
            <div class="cart-item-product-thumb">
              <img src="../images/album_1.jpg" alt="Product" />
            </div>
            <div class="cart-item-product-info">
              <h4 class="cart-item-product-title">{{ producttitle }}</h4>
              <span><strong>編號:</strong> ASK123</span
              ><span><strong>租期:</strong> 2021/11/24</span>
            </div>
          </a>
        </div>
        <div class="px-3 my-3 text-center">
          <div class="cart-item-label">數量</div>
          <div class="count-input">1</div>
        </div>
        <div class="px-3 my-3 text-center">
          <div class="cart-item-label">價格</div>
          <span class="text-xl font-weight-medium">$1,450.00</span>
        </div>
      </div>
      <!-- Cart Item-->
      <div class="cart-item d-md-flex justify-content-between">
      ...
      <div class="container-fluid text-center">
        <div class="row">
          ...
          <div class="col-lg-3">總計 NT1000</div>
          <div class="col-lg-3">訂金預付NT300</div>
        </div>
      </div>
      <div class="container productotice py-4 mt-4">
        <p>透過線上表單填寫登記，同時可以幫您保留喜歡的服飾與配件，</p>
        <p>
          需要取消預約的顧客請您務必在預定的72小時前來電告知，否則無法取消訂單並且無法退還押金。
        </p>
        <p>取消成立後7天內幫您處理退還定金的手續。</p>
        <p>
          預約當天下雨取消預約是無法退還押金。因天氣預報顯示預約當天下雨而更改日期或者時間也無法退還押金。
        </p>
      ...
      <div class="row pt-4">
        <div class="container-fluid text-center col">
          <router-link to="/product-catalogue"
            ><button type="button" class="btn btn-lg check-btn">
              繼續選擇
            </button></router-link
          >
        </div>
