<template>
  ...
  <div @change="onChange">{{ datetime }}</div>
            ...
            <div class="col-md-3">
              <div class="block product">
                <div class="block-image">
                  ...
                  <span
                    class="product-ribbon product-ribbon-right product-ribbon--style-1 bg-pink text-uppercase"
                    >New</span
                  >
                </div>
                  ...
                  <div class="product-buttons mt-4">
                    <div class="row align-items-center">
                      ...
                      <div class="col-6">
                        <button
                          type="button"
                          class="btn btn-block bg-pink  btn-circle btn-icon-left"
                        >
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         ...
         <div class="modal-footer">
          <button
            type="button"
            class="btn btn-secondary closecart"
            data-bs-dismiss="modal"
          >
            單純瀏覽
          </button>
